                    ...
                    <p>Giá vé áp dụng: <br>
                        <div>
                            ...
                            <div class="wrapper">
                                ...
                                <input type="text" id="retail_update" class="dropd-ticket-date" name="giavele" placeholder="Giá vé" style="margin-left: 10px; margin-right: 10px; width: 130px; height: 40px;" disabled> <span style="color: #000; font-weight: 400;">/ vé</span>      
                            </div>
                            <!-- checkbox 02 -->
